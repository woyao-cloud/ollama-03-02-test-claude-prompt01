...
public interface UserRepository extends JpaRepository<User, UUID>, JpaSpecificationExecutor<User> {
     ...
     * @return 用户分页结果
     */
        @Query(value = "SELECT DISTINCT u FROM User u JOIN u.userRoles ur WHERE ur.id.role = :roleId AND u.deletedAt IS NULL",
            countQuery = "SELECT COUNT(DISTINCT u) FROM User u JOIN u.userRoles ur WHERE ur.id.role = :roleId AND u.deletedAt IS NULL")
